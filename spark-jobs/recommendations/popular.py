"""Compatibility wrapper for the current popular-products recommendation job."""
...
TARGET = ROOT / "spark" / "jobs" / "recommendations" / "build_popular_products.py"


def main() -> None:
    parser = argparse.ArgumentParser(description="Popular products recommendation job")
